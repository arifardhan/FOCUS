        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="section-headline text-center">
                    <h2 style="font-size: 28px">Jajaran Pengurus PT. Focus Inservindo</h2>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="team-top">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <div class="single-team-member2">
                        ...
                        <div class="team-content text-center">
                            <h4 style="font-size: 16px;line-height: 26px;font-weight: 600;">Noor Muhammad Nasyar</h4>
                            <p>Bagian Informasi & Teknologi</p>
                        </div>
                    </div>
                </div>
                <!-- End column -->
